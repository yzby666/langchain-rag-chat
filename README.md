...
> ⚠️ At least one of `embeddings` and `embeddingModelOptions` must be provided, otherwise the constructor throws. When both are provided, `embeddings` takes priority.
